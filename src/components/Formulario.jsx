  ...
  return (
    <>
        ...
        <p className="text-lg text-center mb-10">
            Añade tus pacientes y {''}<span className="text-indigo-600 font-bold">Aminístralos</span>
        </p>
        ...
        <form className="bg-white py-10 px-5 mb-10 lg:mb-5 shadow-md rounded-md" onSubmit={handleSubmit}>
            ...
            <div className="mb-5">
                <label htmlFor="fecha" className="text-gray-700 uppercase font-bold">Fecha dado de Alta</label>
